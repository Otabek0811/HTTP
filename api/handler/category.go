...
func (h *handler) CreateCategory(w http.ResponseWriter, r *http.Request) {
	...
	id, err := h.strg.Category().CreateCategory(&category)
	if err != nil {
...
func (h *handler) GetListCategory(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.strg.Category().GetListCategory(&models.CategoryGetListRequest{
		Offset: offset,
		Limit:  limit,
		Search: search,
	})
...
func (h *handler) UpdateCategory(w http.ResponseWriter, r *http.Request) {
	...
	id, err := h.strg.Category().UpdateCategory(&upCategory)
	if err != nil {
